...
<div class="container">
    ...
    <div class="post_input_card">
        {{ Form::open([
            ...
            <h3 class="post_input_card--title">Meme Submission <span class="label label-info">New</span></h3>
            <hr>
            <!-- TITLE -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input id="input_file" type="file" class="form-control" name="file" accept="{{Common::_desc['media_credentials_accept'][$default_media]}}" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    {{ Form::select('media', Common::_desc['media'], $default_media, [
                        'id'    => 'input_media',
                        'class' => 'form-control',
                        'value' => old('media'),
                        'required',
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {{ Form::textarea('description', null, [
                        ...
                        'class' => 'form-control',
                        'placeholder'   => 'Insert your hashtags here #HelloWorld',
            ...
            <div class="form-group">
                <div class="col-md-8 col-md-offset-4">
                    ...
                    <a href= "{{ URL::previous() }}" class="btn button_cancel"> Cancel </a>
                </div>
            </div>
...
const media_creds_accpet = JSON.parse('<?php echo json_encode(Common::_desc["media_credentials_accept"]) ?>');
...
$("#input_media").get(0).onchange = function() {
    ...
    $("#input_file").val(''); 
    $("#input_file").prop('accept', media_creds_accpet[this.value]);
}
